...
You may also add a content ID for reference in an inline embedded image using
the CID method (see asdf for more info). For example, you may add your image
with a CID and reference that in your HTML.:
